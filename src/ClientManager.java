   ...
   jTableClients.addMouseListener(new java.awt.event.MouseAdapter() {
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (row != -1) {
            ...
            int clientId = (int) jTableClients.getValueAt(row, 0);
            ClientService clientService = new ClientService();
            Client selectedClient = clientService.findById(clientId);

            if (selectedClient != null) {
                onClientRowSelected(selectedClient);
            }
        }
    }
});
    ...
    private void initComponents() {
        ...
        jTableClients.setFont(new java.awt.Font("Calibri", 0, 18));
        jTableClients.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CIN", "Nom Complet", "Telephone", "Email", "Crée le"
            }
        ) {
        ...
        jTableClients.setAlignmentX(1.0F);
        jTableClients.setAlignmentY(2.0F);
        jTableClients.setCellSelectionEnabled(true);
        jTableClients.setRowHeight(25);
        jTableClients.setShowGrid(true);
        jScrollPane1.setViewportView(jTableClients);
        jTableClients.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        ...
        jLabel11.setText("NOM ET PRENOM");
        ...
        jTextFieldPhone.setBackground(new java.awt.Color(227, 255, 255));
        ...
        jTextFieldCIN.setBackground(new java.awt.Color(232, 255, 255));
        ...
        jTextFieldName.setBackground(new java.awt.Color(227, 255, 255));
        ...
        jTextFieldEmail.setBackground(new java.awt.Color(227, 255, 255));
        ...
        jLabel1.setText("Recherche par CIN :");
        ...
        ClientPanelLayout.setHorizontalGroup(
            ...
            .addGroup(ClientPanelLayout.createSequentialGroup()
                ...
                .addGroup(ClientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jTextFieldCIN, javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(ClientPanelLayout.createSequentialGroup()
                ...
                .addGroup(ClientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(ClientPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(jTextFieldCIN, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(12, 12, 12)
...
private void searchClientByCIN(String cin) {
    ...
    List<Client> clients = clientService.findByCIN(cin);  // Call the instance method
    updateTable(clients);
}
...
private void updateTable(List<Client> clients) {
    ...
    for (Client client : clients) {
        model.addRow(new Object[] { client.getId(), client.getCIN(), client.getN_Complet(), client.getTelephone(), client.getEmail(), client.getCreated_at() });
    }
}
private void loadClients() {ClientService clientService = new ClientService();
...
private void showOptionDialog(Client client) {
...
private int selectedClientId = -1;  // This will store the client ID if you're updating

private void onClientRowSelected(Client selectedClient) {
    // Set form fields with the selected client’s data
    jTextFieldCIN.setText(selectedClient.getCIN());
    jTextFieldName.setText(selectedClient.getN_Complet());
    jTextFieldPhone.setText(selectedClient.getTelephone());
    jTextFieldEmail.setText(selectedClient.getEmail());

    // Update global variables for updating state
    isUpdating = true;
    ...
    // Prompt the user for delete or update
    String[] options = {"Modifier", "Supprimer", "Annuler"};
    int choice = JOptionPane.showOptionDialog(
        this,
        "Que souhaitez-vous faire avec le client sélectionné ?",
        "Options Client",
        JOptionPane.DEFAULT_OPTION,
    ...
    if (choice == 0) { // Update option
        // Simply leave the form pre-filled and let the user modify it
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            // Perform deletion
            ClientService clientService = new ClientService();
            if (clientService.delete(selectedClient)) {
                JOptionPane.showMessageDialog(this, "Client supprimé avec succès !");
                loadClients(); // Refresh table
                resetForm(); // Reset form after deletion
            } else {
                JOptionPane.showMessageDialog(this, "Échec de la suppression du client.");
            }
        }
    } else {
        // Cancel option
...
// This is the action handler for the button (Add/Update)
private void AddActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if (isUpdating) {
        ...
        Client updatedClient = new Client(selectedClientId, cin, name, telephone, email, new Timestamp(System.currentTimeMillis()));
           ClientService  clientService = new ClientService();
        ...
        // Add a new client
        Client newClient = new Client(cin, name, telephone, email, new Timestamp(System.currentTimeMillis()));
     ClientService  clientService = new ClientService();
        if (clientService.create(newClient)) {
            JOptionPane.showMessageDialog(this, "Client ajouté avec succès!");
        } else {
            JOptionPane.showMessageDialog(this, "Echec d'ajout ");
        }
    }
loadClients();
    resetForm();
...
// This method is used to reset the form after an add/update
private void resetForm() {
    ...
    // Reset the state to "add" mode
    isUpdating = false;
    selectedClientId = -1;
}

// Method to open update form with client data pre-filled
private void openUpdateClientForm(Client client) {
    jTextFieldCIN.setText(client.getCIN());
    jTextFieldName.setText(client.getN_Complet());
    jTextFieldPhone.setText(client.getTelephone());
    jTextFieldEmail.setText(client.getEmail());

    // Open modal form or allow user to update details
}
...
private void deleteClient(Client client) {
    int confirm = JOptionPane.showConfirmDialog(
        this,
        "Êtes vous sûre de supprimer ce client ?",
        "Supprimer Client",
        JOptionPane.YES_NO_OPTION,
        JOptionPane.WARNING_MESSAGE
    );
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        String cin = jTextFieldSearch.getText(); // Get CIN input from the text field

        if (!cin.isEmpty()) {
            searchClientByCIN(cin); // Call the search method
        } else {            JOptionPane.showMessageDialog(this, "Entrer un CIN  svp .");
        }
