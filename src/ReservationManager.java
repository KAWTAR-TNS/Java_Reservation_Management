...
public class ReservationManager extends javax.swing.JFrame {
 ...
 jTableReservations.addMouseListener(new java.awt.event.MouseAdapter() {
    ...
    private void initComponents() {
        ...
        Statistics1.setText("Statistiques");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(Statistics1, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                .addGap(18, 18, 18)
...
private void handleConfirmReservation(int reservationId) {
    ...
    if (success) {
        JOptionPane.showMessageDialog(this, "Reservation confirmée avec  succès !");
        loadReservations(); // Refresh the table
    } else {
        JOptionPane.showMessageDialog(this, "Echec de confirmation de la réervation.");
    }
}
private void handleCancelReservation(int reservationId) {
    ...
    if (success) {
        JOptionPane.showMessageDialog(this, "Reservation annulée avec succès !");
        loadReservations(); // Refresh the table
    } else {
        JOptionPane.showMessageDialog(this, "Echec d'annulation !.");
    }
}
...
private void AddActionPerformed(java.awt.event.ActionEvent evt) {                                      
    try {
        ...
        if (datefin.before(datedebut)) {
            JOptionPane.showMessageDialog(this, "L date de fin doit être après la date de début .");
            return;
        }
...
double price = resService.calculatePrice(reservation);
        ...
        if (success) {
            JOptionPane.showMessageDialog(this, "Reservation ajoutée avec succés!");
            resetForm();  // Reset the form
            loadReservations();  // Refresh the table with updated reservations
        } else {
            JOptionPane.showMessageDialog(this, " La chambre n'est pas  valable pour les dates seléctionnées .");
        }
    } catch (Exception e) {
...
try {
        ...
        Date datedebut = jDateSearchDebut.getDate();  
        Date datefin = jDateSearchFin.getDate();  
        
        // Check if dates are selected
        if (datedebut == null || datefin == null) {
            JOptionPane.showMessageDialog(this, "SVP Sélectionnez les deux dates !.");
            return;
        }
        ...
        if (reservations.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Pas de resérvations pour la criteria selectionnée.");
        }
